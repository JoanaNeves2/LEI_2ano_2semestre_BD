...
-- Outras restricoes
-- ***** Trabalho ***** 
-- adicione uma restrição chamada numCred que verifica (em cadeiras) que o número de ects está entre 3 e 60
...
-- ***** Trabalho ***** 
-- Insere outro aluno à sua escolha em matriculas (por exemplo, veja na tabela dos colocados um colocado em Matemática (9209)) 


-- Já agora, veja quem ficou matriculado.
...
-- 4.1
-- ***** Trabalho *****
-- corra os seguintes comandos individualmente, vai haver um erro - tente perceber a razão e como ajustar.
...
-- Nota: com isto o esquema deixa de estar normalizado (irá ver o que isto significa nas próximas aulas teóricas)!
...
-- Mas em 2023 já deve dar... experimente.
